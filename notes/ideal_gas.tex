...
thinks in Newton's; have you ever picked up a suitcase and said
...
units of mass times the units of acceleration, of $kg-m/s^2$.  This is
...
bouncing off the lid.  Every time a molecule bounces off the lid, it's
velocity changes, and a change in velocity means an acceleration.
...
grams, physicists wanted a mole of hydrogen to be one gram, so they
compromised and said a mole of carbon-12 would be 12 grams.}.  The
...
velocity of
\begin{equation}
  v_x=\sqrt{\frac{1.38e-23\times 293}{5e-26} }=280 m/s
\end{equation}
